...
import static com.laioffer.myapplication.R.drawable.event;
...
public class ReportEventFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!mPicturePath.equals("")) {
            //dont know why but key is shown as an int, so change key to uploadEvent()111
            uploadImage(mPicturePath, uploadEvent());
            mPicturePath = "";
        }
